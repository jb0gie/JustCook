...
public class MealOnePriceOne extends ListActivity{
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     // storing string resources into Array
        String[] meal_one_price_one = getResources().getStringArray(R.array.meal_one_price_one);
         
        // Binding resources Array to ListAdapter
        this.setListAdapter(new ArrayAdapter<String>(this, R.layout.price_one, R.id.label_one, meal_one_price_one));
        
        
        ListView lv = getListView();
     // MEALS FOR 1 FOR £5   
     // Pizza Toast, Single-Serve Mug Cake & Tuna & Beans 
